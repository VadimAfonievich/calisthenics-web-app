...
export type TenantContext={id:string;slug:string;name:string;role:'coach'|'student';description?:string;avatar_media_id?:string;avatar_url?:string;telegram_avatar_url?:string;avatar_initials?:string}
