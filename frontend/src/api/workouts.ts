...
export type Workout={id:string;title:string;description:string;estimated_minutes:number;difficulty:string;program_id?:string;program_name?:string;category?:string;warmup_enabled?:boolean;warmup_workout_id?:string;default_warmup?:WarmupSummary;cover_media_url?:string;system?:boolean;exercises:WorkoutExercise[]}
export type WorkoutCatalogItem={id:string;title:string;description:string;estimated_minutes:number;difficulty:string;exercise_count:number;program_id?:string;program_name?:string;category:string;warmup_enabled:boolean;cover_media_url?:string;status?:string;active_session_id?:string;system?:boolean}
