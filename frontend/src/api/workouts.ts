...
export const complete=(t:string,s:string,d:number)=>api<{session:{xp_earned:number;current_streak:number;unlocked_achievements:string[]}}>(`/workout-sessions/${s}/complete?duration_seconds=${d}`,{method:'POST'},t)
