...
export type Workout={id:string;title:string;description:string;estimated_minutes:number;difficulty:string;program_id:string;program_name:string;cover_media_url?:string;exercises:WorkoutExercise[]}
